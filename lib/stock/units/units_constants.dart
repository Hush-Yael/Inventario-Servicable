...
/// Used in a query to get all the product options for units edit cell option selection
const kUnitsProductOptionsQueryKey = ['productOptions'];

/// Used in a query to get all the category options for units edit filtering
const kUnitsCategoryOptionsQueryKey = ['unitsCategoryOptions'];
